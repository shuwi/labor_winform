...
namespace LaborStackApp.Toolkits
{
    public partial class PageUserControl : UserControl
    {
        ...
        private void DrawControl(bool callEvent)
        {
            ...
            currentLabel.Text = string.Format("{0} / {1}", PageIndex, PageCount);
            lblTotalCount.Text = string.Format("共 {0} 条记录", RecordCount);
        ...
        private void PageUserControl_Load(object sender, EventArgs e)
        {
            if (PageCount == 1)//有且仅有一页时
            {
                linkFirst.Enabled = false;
            ...
            txtPageSize.TextChanged += TxtPageSize_TextChanged;
